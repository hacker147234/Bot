...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EukghphxZOAlVi8DI7D8.0CoJL3ZSnW6yIqR8ZjTHMa.mIhkd+nVGZatOw8QsE7aXP++ZNjhksJLJcshJbB7icU=') 
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EujbcZhky1REmn4dH4w1.QUh0qSq85ioLjRUtmHr4Gq.jqKb1FX1T9vvNQaUwB+jp6lnO1p90tM6o2s0cx0tp4o=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='Eu6hySTWznuJ48lL0Zb9.rpEO1I2clK1nmIKedtIfkq.IW6d/4nogspXonf7SJntTHihv9F4A2e1eiLBd8xRzz8=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='Eu2fQw4expTl3BY0pon1.hF0jPxTynR0gCZoRABtXqq.EUqJRBPviIOgB/E/rv+wArWdIR3zn5an9P3881/QVUA=') 
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EuxdDnJiWLTbP3Wqs4J7.+7N7PFMGhkPlNoPHlBqn5W.9VhvhN/561UOFliefAIJ7bednSyeG0yYARivwItX2KI=') 
kr.loginResult()
print "Kr-Login Success\n"

vipro = LINETCR.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
#vipro.login(qr=True)
vipro.login(token='EuYwaHkKBplNtHGUmgf0.wPAtTDMMvev1GuCiOkg60a.XraOt8mxeoy7OR5W1PKIdu00gc0N8DFks3PTpaMr90I=')
vipro.loginResult()
print "Vipro-Login Success\n"

km = LINETCR.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#km.login(qr=True)
km.login(token='EuvercvzcKTVPRLRA9K5.b6qZRwD+s9gw8V5XtPCi5q.S/6SDtCkgy0yEYhq56agX3M/bk5rhGgyTaeReJQnbIM=') 
km.loginResult()
...
"""
vip="u5a9693b5d9a6544575814708a0a1bad0"
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"u5a9693b5d9a6544575814708a0a1bad0","u44f7a8d62d822e4d4d3229040d388529","uaae1f442c43ce483a526bb9332147881","u615cf941e76af1ae1692e175547d94fc","ue44e97f6c8e06a52bd33be103f4f5d87","u3ec8b17232ffdd25020a0ff0a594c96c"]
Creator=["u5a9693b5d9a6544575814708a0a1bad0"]
admin=["u5a9693b5d9a6544575814708a0a1bad0","u44f7a8d62d822e4d4d3229040d388529","uaae1f442c43ce483a526bb9332147881","u615cf941e76af1ae1692e175547d94fc","ue44e97f6c8e06a52bd33be103f4f5d87","u3ec8b17232ffdd25020a0ff0a594c96c"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment1":"Auto Like ©By : Jomblo\nContact Me : 👉 line.me/ti/p/~sandy_erenjaeger",
    "comment2":"Auto Like ©By : Jomblo\nContact Me : 👉 line.me/ti/p/~sandy_erenjaeger",
    "comment3":"Auto Like ©By : Jomblo\nContact Me : 👉 line.me/ti/p/~sandy_erenjaeger",
    "comment4":"Auto Like ©By : Jomblo\nContact Me : 👉 line.me/ti/p/~sandy_erenjaeger",
    "comment5":"Auto Like ©By : Jomblo\nContact Me : 👉 line.me/ti/p/~sandy_erenjaeger",    
    "commentOn":True,
    "commentBlack":{},
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Sekali lagi nge tag gw sumpahin jomblo seumur hidup!","Bacot Lu Ahh!!!",cName + " Ngapain Ngetag?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja","Tag Mulu Lo Anjirr!","Dia Lagi Off", cName + " Kenapa Tag? Sagne?","Dia Lagi Tidur\nJangan Di Tag " + cName, "Jangan Suka Tag Gua " + cName, "Kamu Siapa " + cName + "?", "Ada Perlu Apa Mblo " + cName + "?","Woii " + cName + " Jangan Ngetag, Riibut!"]
                     ret_ = random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
			...
			cl.sendText(msg.to,"Admin Detected~")
                    ...
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        ...
                        wait["dblacklist"] = False
                        random.choice(KAC).sendText(msg.to,"Tidak Ada Tersangka")
            ...
            elif msg.text in ["Creator","Owner","Own","own"]:
                msg.contentType = 13
		...
		cl.sendText(to,"❂•••••••••✧••••••••••❂")
            ...
            elif msg.text in ["Admin","admin","Mimin","mimin"]:
                msg.contentType = 13
                admin1 = "u5a9693b5d9a6544575814708a0a1bad0"
...
#		else:                    
		    ...
		    cl.sendText(msg.to,"Khusus Creator")
                ...
                wait["Sider"] = True
                cl.sendText(msg.to,"Cek Sider On BosQ")
                ...
                md = ""
		if wait["Sambutan"] == True: md+="❂➣📱 Notif : On\n"
		...
		if wait["Simi"] == True: md+="❂➣📱️ Simisimi : On\n"
            ...
            elif msg.text in ["Jomblo1 gift","jomblo1 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["Jomblo2 gift","jomblo2 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["Jomblo3 gift","jomblo3 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'ae3d9165-fab2-4e70-859b-c14a9d4137c4',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '8'}
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                midd = "u5a9693b5d9a6544575814708a0a1bad0"
                random.choice(KAC).inviteIntoGroup(msg.to,[midd])

            elif msg.text in ["Welcome","welcome","Welkam","welkam","Wc","wc,Kam"]:
                gs = cl.getGroup(msg.to)
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to,"Sape lu njirr!")

            elif msg.text in ["Jomblo1 join"]:
		if msg.from_ in admin:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
		    ...
		    cl.sendText(msg.to,"Sape lu njirrr!")

            elif msg.text in ["Jomblo2 join"]:
		if msg.from_ in admin:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
		...
		try:
		    ...
		    print E
              ...
              if wait["Leave"] == True:		    
		          ...
		          cl.sendText(msg.to,"Hayooo Lupa")                    
		    ...
		    wait["Leave"] = False
		          ...
		          cl.sendText(msg.to,"Sape Lu Admin Bukan Owner bukan Dasar Jomblo😛")		    
		    

            elif msg.text in ["Absen"]:
		cl.sendText(msg.to,"Absen Coeg!!!")
                ki.sendText(msg.to,"Bot1 Hadiir BosQ ")
                kk.sendText(msg.to,"Bot2 Hadiir BosQ ")
                kc.sendText(msg.to,"Bot3 Hadiir BosQ ")
                kr.sendText(msg.to,"Bot siap beroperasi ")
		...
		cl.sendText(msg.to, "Menghitung duit...")
                random.choice(KAC).sendText(msg.to,"SPEED BOT\n" +  "%sseconds" % (elapsed_time)+ "\nRENDRA BOT")
		...
		if msg.from_ in Creator:
		    ...
		    cl.sendText(msg.to,"Lu sape njirrr!")
              ...
              if msg.from_ in admin:
                if wait["blacklist"] == {}:
                    random.choice(KAC).sendText(msg.to,"Noting blacklist...")
                else:
                    mc = ""
                    for mi_d in wait["blacklist"]:
                        mc += "->" +cl.getContact(mi_d).displayName + "\n"
                    random.choice(KAC).sendText(msg.to,"═══T E R S A N G K A═══\n"+mc)
                ...
                if msg.from_ in admin:
                    wait["blacklist"] = {}
                    cl.sendText(msg.to,"BLACKLIST ALL DELETED") 

            elif msg.text.lower() in ["bot","jomblo"]:
                cl.sendText(msg.to,"Apa Mblo Manggil~Manggil!? Gabut ya mblo😛") 
		...
		if msg.from_ in admin:
                    if msg.toType == 2:
                        ...
                        ki.sendText(msg.to,"Minggat lu kicker😛")
		else:
		    cl.sendText(msg.to, "Khusus creator")
		...
		if msg.from_ in Creator:
              ...
              if msg.from_ in Creator:
            ...
            elif "Jomblo1 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("Jomblo1 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = ki.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                       ...
                       for target in targets:
                            try:
                               ...
                               ki.sendText(msg.to, "Copied (^_^)")
                                ...
                                print e
            elif "Jomblo2 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("Jomblo2 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kk.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "Jomblo3 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("Jomblo3 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kc.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "Jomblo copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("Jomblo4 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kr.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
               ...
               if msg.from_ in admin:
            	...
            	if msg.from_ in admin:
                    ...
                    beb = "Hi kk sayang" +cl.getContact(msg.from_).displayName
            ...
            elif "/jomblo" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/jomblo","Jomblo")
            ...
            elif "/jomblo1" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/jomblo1","Jomblo1")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/jomblo2" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/jomblo2","Jomblo2")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/jomblo3" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/jomblo3","Jomblo3")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/jomblo4" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/jomblo4","Jomblo4")
                    if len(string.decode('utf-8')) <= 5000:
                        profile = cl.getProfile()
                        profile.displayName = string
                        kr.updateProfile(profile)
            ...
            elif msg.text in ["Jomblo1 acc invite"]:
                if msg.from_ in admin:
                    gid = ki.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["Jomblo2 acc invite"]:
                if msg.from_ in admin:
                    gid = kk.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["Jomblo3 acc invite"]:
                if msg.from_ in admin:
                    gid = kc.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["Jomblo4 acc invite"]:
                if msg.from_ in admin:
