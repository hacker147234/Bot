...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EtZJMfwH8Nm7X0hNL4b1.QUh0qSq85ioLjRUtmHr4Gq.c5Cj6EGst+poi1Ckl9kZBNIfYnVnbX+caEVzin2F7d4=') 
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EtsEbjria0OXD4ACANT9.rpEO1I2clK1nmIKedtIfkq.aL68uQifxBhA5tcn+uqeoDsU99s8T+c/ynweQYRc6rI=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='Etvhe1cDPVv66YxmwiPc.yvZ5qEDQ8A4wKUf1vh2u+a.DqMb6LQjn4vy8Q/kOMMHRzUhq125XK9kcwVboU9Ww/4=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='Et4Nz4SzbQiXRTOkpIB7.+7N7PFMGhkPlNoPHlBqn5W.7x/rYSmyGV56fid4Qj+hZC5PmMm+Ffp10Pw5KoDILt8=') 
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EtAmMxoBG7w8p4OeYg78.0CoJL3ZSnW6yIqR8ZjTHMa.f71IdYfqOog+pEYlTYeZNr50tggy/tymLzk0TItTueQ=') 
kr.loginResult()
print "Kr-Login Success\n"

vipro = LINETCR.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
#vipro.login(qr=True)
vipro.login(token='EtWTaP5FkjWvLRVW7Vr0.wPAtTDMMvev1GuCiOkg60a.KeUBFu1vMBeP/USItfbzqGlZadyAy/9jaa795Lz91wU=')
vipro.loginResult()
print "Vipro-Login Success\n"

km = LINETCR.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#km.login(qr=True)
km.login(token='EtrFRLJ8HFiIVyUqw9c3.ikd3n/eRXl5/eLzgfYB+SW.MKteDueMKC8059sARijh5SUQHTt01xH9ADO/PScS9ec=') 
km.loginResult()
...
admin=["u5a9693b5d9a6544575814708a0a1bad0"]
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
        ...
        if op.type == 26:
            ...
            elif msg.text in ["Creator","Owner,Own"]:
                msg.contentType = 13
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus Jomblo")
...
#		else:                    
		    ...
		    cl.sendText(msg.to,"Khusus Jomblo")
                ...
                if msg.to in cctv['point']:
                    ...
                    wait["Sider"] = False
                    cl.sendText(msg.to, "Yahh Cek Sider Off")
                else:
		...
		cl.sendText(msg.to,"Absen Mblo!!!")
                ki.sendText(msg.to,"jomblo1 Hadiir BosQ \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"jomblo2 Hadiir BosQ \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"jomblo3 Hadiir BosQ \(ˆ▿ˆ)/")
                kr.sendText(msg.to,"Hadiir Semua Jomblo squad  \(ˆ▿ˆ)/")
              ...
              if msg.from_ in Creator:
               ...
               if msg.from_ in admin:
            	...
            	if msg.from_ in admin:
                    ...
                    beb = "Hi kk jelek" +cl.getContact(msg.from_).displayName
